...
import RepresentItemList from "components/Represent/RepresentItemList";
...
const RepresentativeProject: FunctionComponent<PostListType> = function ({
                                                                              posts
                                                                          }) {
    return (
